...
export const SVG_PATHS = {
    ...
    settings: {
        viewBox: "0 0 24 24",
        path: '<path d="M19.43 12.98c.04-.32.07-.64.07-.98s-.03-.66-.07-.98l2.11-1.65c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.3-.61-.22l-2.49 1c-.52-.39-1.1-.65-1.7-.83L14 2h-4l-.28 2.05c-.6.18-1.17.44-1.7.83L4.93 4.3c-.22-.08-.49 0-.61.22l-2 3.46c-.12.22-.07.49.12.64l2.11 1.65c-.04.32-.07.64-.07.98s.03.66.07.98l-2.11 1.65c-.19.15-.24.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1c.52.39 1.1.65 1.7.83L10 22h4l.28-2.05c.6-.18 1.17-.44 1.7-.83l2.49 1c.22.08.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.65zM12 15.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5-1.57 3.5-3.5 3.5z"/>',
    },
    // Archive (box)
    archive: {
        viewBox: "0 0 24 24",
